...
def main():
    ...
    csv_data.head()
    ids = csv_data.index
    ex1 = csv_data.loc[1845]
    pred1 = predict_using_probability(ex1.loc['gender'],ex1.loc['age'],ex1.loc['hypertension'],ex1.loc['heart_disease'],ex1.loc['ever_married'],ex1.loc['work_type'],ex1.loc['Residence_type'],ex1.loc['avg_glucose_level'],ex1.loc['bmi'],ex1.loc['smoking_status'])
    print(ex1)
    print("\n")
    print(pred1)
